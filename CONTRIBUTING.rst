...
.. _GitHub: https://github.com/DiamondLightSource/arc_hvbias/issues
...
To get the source source code and run the unit tests, run::
    ...
    $ git clone git://github.com/DiamondLightSource/arc_hvbias.git
    $ cd arc_hvbias
    $ pipenv install --dev
    $ pipenv run tests
...
.. _release: https://github.com/DiamondLightSource/arc_hvbias/releases
